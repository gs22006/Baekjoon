...
메모리: 201212 KB, 시간: 2700 ms

### 분류

그래프 이론(graphs), 다익스트라(dijkstra), 분할 정복(divide_and_conquer), 다이나믹 프로그래밍(dp), 분할 정복을 사용한 최적화(divide_and_conquer_optimization), 누적 합(prefix_sum)
